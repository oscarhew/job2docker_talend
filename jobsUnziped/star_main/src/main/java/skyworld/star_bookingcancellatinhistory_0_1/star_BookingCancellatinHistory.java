...
package skyworld.star_bookingcancellatinhistory_0_1;
...
/**
 * Job: star_BookingCancellatinHistory Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class star_BookingCancellatinHistory implements TalendJob {
...
public String getPipelineUUID(){
	...
	private final String jobName = "star_BookingCancellatinHistory";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_m1MyEE4TEe6QafprtIr0FQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				star_BookingCancellatinHistory.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(star_BookingCancellatinHistory.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_SKYWORLD_star_BookingCancellatinHistory = new byte[0];
    static byte[] commonByteArray_SKYWORLD_star_BookingCancellatinHistory = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SKYWORLD_star_BookingCancellatinHistory.length) {
				if(length < 1024 && commonByteArray_SKYWORLD_star_BookingCancellatinHistory.length == 0) {
   					commonByteArray_SKYWORLD_star_BookingCancellatinHistory = new byte[1024];
				} else {
   					commonByteArray_SKYWORLD_star_BookingCancellatinHistory = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SKYWORLD_star_BookingCancellatinHistory, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_BookingCancellatinHistory, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SKYWORLD_star_BookingCancellatinHistory, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_BookingCancellatinHistory, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SKYWORLD_star_BookingCancellatinHistory) {
...
public static class cancellationpipelineStruct implements routines.system.IPersistableRow<cancellationpipelineStruct> {
    final static byte[] commonByteArrayLock_SKYWORLD_star_BookingCancellatinHistory = new byte[0];
    static byte[] commonByteArray_SKYWORLD_star_BookingCancellatinHistory = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final cancellationpipelineStruct other = (cancellationpipelineStruct) obj;
	...
	public void copyDataTo(cancellationpipelineStruct other) {
	...
	public void copyKeysDataTo(cancellationpipelineStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(cancellationpipelineStruct other) {
...
cancellationpipelineStruct cancellationpipeline = new cancellationpipelineStruct();
cancellationpipelineStruct row2 = cancellationpipeline;
...
String tableName_tDBOutput_1 = "property_booking_cancellation_history";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YHKw8kush93LXK/iiq1j5HKv08GrbdgO6bA7zAPpoPnmQH96Uq9oPbKt");
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "property_booking_cancellation_history" + "` (`BookingCancellationID`,`Type`,`BookingDate`,`ExpiryDate`,`DateCancellation`,`Reason`,`Remark`) VALUES (?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tFlowMeter_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"cancellationpipeline");
					}
...
cancellationpipelineStruct cancellationpipeline_tmp = new cancellationpipelineStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:1qTr7+KzvQlMPY6kqjg1GUQ8+LLzEissCt210+B6B2ZgZR/5MahCfxGI");
...
+"y_cancellationhistory`.`BookingDate`, \n  `property_cancellationhistory`.`ExpiryDate`, \n  `property_cancellationhistory`."
+"`DateCancellation`, \n  `property_cancellationhistory`.`Reason`, \n  `property_cancellationhistory`.`Remark`\nFROM `propert"
+"y_cancellationhistory`";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row1.CancellationHIstoryID = 0;
							} else {
		                          
            row1.CancellationHIstoryID = rs_tDBInput_2.getInt(1);
        	...
        	row1.Type = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
				...
				if(rs_tDBInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.BookingDate = rs_tDBInput_2.getTimestamp(3);
					} else {
						row1.BookingDate = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.BookingDate =  null;
				}
				...
				if(rs_tDBInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.ExpiryDate = rs_tDBInput_2.getTimestamp(4);
					} else {
						row1.ExpiryDate = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.ExpiryDate =  null;
				}
							...
							if(colQtyInRs_tDBInput_2 < 5) {
								row1.DateCancellation = null;
							} else {
										
				if(rs_tDBInput_2.getString(5) != null) {
					String dateString_tDBInput_2 = rs_tDBInput_2.getString(5);
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.DateCancellation = rs_tDBInput_2.getTimestamp(5);
					} else {
						row1.DateCancellation = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.DateCancellation =  null;
				}
        	...
        	row1.Reason = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row1.Remark = null;
							} else {
	                         		
        	row1.Remark = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
		                    }
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
			   	  		  ...
			   	  		  if(
 				  		  			...
 				  		  			row1.ExpiryDate.after(row1.BookingDate)
...
Var.var1 = TalendDate.formatDate("yyyy-MM-dd", row1.ExpiryDate) ;
Var.var2 = TalendDate.formatDate("yyyy-MM-dd", row1.DateCancellation) ;
Var.var3 = null;// ###############################
        // ###############################
        // # Output tables

cancellationpipeline = null;


// # Output table : 'cancellationpipeline'
cancellationpipeline_tmp.BookingCancellationID = row1.CancellationHIstoryID ;
cancellationpipeline_tmp.Type = ("Booked".equals(row1.Type) || "Reserved".equals(row1.Type)) ? row1.Type : "Default" ;
cancellationpipeline_tmp.BookingDate = row1.BookingDate;
cancellationpipeline_tmp.ExpiryDate = row1.ExpiryDate ;
cancellationpipeline_tmp.DateCancellation = row1.DateCancellation ;
cancellationpipeline_tmp.Reason = row1.Reason;
cancellationpipeline_tmp.Remark = row1.Remark;
cancellationpipeline = cancellationpipeline_tmp;
// ###############################
 ...
 */
// Start of branch "cancellationpipeline"
if(cancellationpipeline != null) { 
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            pstmt_tDBOutput_1.setInt(1, row2.BookingCancellationID);
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
                            ...
                            if(row2.BookingDate != null) {
date_tDBOutput_1 = row2.BookingDate.getTime();
...
date_tDBOutput_1 = row2.ExpiryDate.getTime();
if(date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
...
pstmt_tDBOutput_1.setNull(4, java.sql.Types.DATE);
                            ...
                            if(row2.DateCancellation != null) {
date_tDBOutput_1 = row2.DateCancellation.getTime();
if(date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
...
} else {pstmt_tDBOutput_1.setString(6, row2.Reason);
}

                            if(row2.Remark == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, row2.Remark);
}
...
} // End of branch "cancellationpipeline"
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("cancellationpipeline", new Integer(count_tFlowMeter_6), "null", "", "tFlowMeter_6");

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"cancellationpipeline");
			  	}
...
java.sql.Connection conn_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:mKlgbWIqQYE6qP9SCCNCIJlk/aXl+G4Y1cRbpm0yW/8OThhprQJO1+JG");
...
pipeline_tmp.ID = 0;
pipeline_tmp.table_involved = "property_booking_cancellation_history";
 ...
 */
    ...
    public static void main(String[] args){
        final star_BookingCancellatinHistory star_BookingCancellatinHistoryClass = new star_BookingCancellatinHistory();

        int exitCode = star_BookingCancellatinHistoryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = star_BookingCancellatinHistory.class.getClassLoader().getResourceAsStream("skyworld/star_bookingcancellatinhistory_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = star_BookingCancellatinHistory.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : star_BookingCancellatinHistory");
        }
...
/************************************************************************************************
 *     165112 characters generated by Talend Open Studio for Big Data 
