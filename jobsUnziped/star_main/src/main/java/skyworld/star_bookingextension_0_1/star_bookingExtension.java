...
package skyworld.star_bookingextension_0_1;
...
/**
 * Job: star_bookingExtension Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class star_bookingExtension implements TalendJob {
...
public String getPipelineUUID(){
	...
	private final String jobName = "star_bookingExtension";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_VRC7UF4YEe6ZffCEwh--gg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				star_bookingExtension.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(star_bookingExtension.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_SKYWORLD_star_bookingExtension = new byte[0];
    static byte[] commonByteArray_SKYWORLD_star_bookingExtension = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SKYWORLD_star_bookingExtension.length) {
				if(length < 1024 && commonByteArray_SKYWORLD_star_bookingExtension.length == 0) {
   					commonByteArray_SKYWORLD_star_bookingExtension = new byte[1024];
				} else {
   					commonByteArray_SKYWORLD_star_bookingExtension = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SKYWORLD_star_bookingExtension, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_bookingExtension, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SKYWORLD_star_bookingExtension, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_bookingExtension, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SKYWORLD_star_bookingExtension) {
		...
		synchronized(commonByteArrayLock_SKYWORLD_star_bookingExtension) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DateOldExpired = readDate(dis);
					
					this.DateExtended = readDate(dis);
					
					this.Reason = readString(dis);
					
					this.AddedBy = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.DateOldExpired,dos);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.ExtensionHistoryID;
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						if (this.ExtensionHistoryID != other.ExtensionHistoryID)
							return false;
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.ExtensionHistoryID, other.ExtensionHistoryID);
						if(returnValue != 0) {
							return returnValue;
						}
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:gURGbLI98yeVarVV7ZUPZov2qqs8gtdIUQVX45FYRpnXFa5dhJbXphH8");
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "property_booking_extensions" + "` (`ExtensionID`,`Reason`,`DateExtended`) VALUES (?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OTt+DrNq3tTVhTWg5SLAGB8J+g6UKG1wlm2qW2wb8BhMsdYXUMyNzr4g");
...
+"operty_extensionhistory`.`CreatedBy`, \n  `property_extensionhistory`.`ModifiedBy`\nFROM `property_extensionhistory`";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.ExtensionHistoryID = 0;
							} else {
		                          
            row1.ExtensionHistoryID = rs_tDBInput_1.getInt(1);
            ...
            row1.BookingUnitID = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.UnitID = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.CustomerID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.DateOldExpired = null;
							} else {
				...
				if(rs_tDBInput_1.getString(6) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateOldExpired = rs_tDBInput_1.getTimestamp(6);
					} else {
						row1.DateOldExpired = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.DateOldExpired =  null;
				}
				...
				if(rs_tDBInput_1.getString(7) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateExtended = rs_tDBInput_1.getTimestamp(7);
					} else {
        	...
        	row1.Reason = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.AddedBy = null;
							} else {
	                         		
        	row1.AddedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.Remark = null;
							} else {
	                         		
        	row1.Remark = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.Deleted = null;
							} else {
	                         		
            row1.Deleted = rs_tDBInput_1.getBoolean(11);
            if(rs_tDBInput_1.wasNull()){
                    row1.Deleted = null;
            }
		                    }
				...
				if(rs_tDBInput_1.getString(12) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateCreated = rs_tDBInput_1.getTimestamp(12);
					} else {
				...
				if(rs_tDBInput_1.getString(13) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateModified = rs_tDBInput_1.getTimestamp(13);
					} else {
        	...
        	row1.CreatedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.ModifiedBy = null;
							} else {
	                         		
        	row1.ModifiedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
...
row2.ExtensionHistoryID = row1.ExtensionHistoryID;
row2.Reason = row1.Reason;

String reason = row1.Reason;
if(reason == null || reason.contains("Test") ){
	reason = "Reason Invalid";
}
else if(reason.contains("GM")){
	reason = "Pending GM";
}
else if(reason.contains("CANCELLATION")){
	reason = "Cancellation";
}
else if(reason.contains("EXTENSION") || reason.contains("extension") || reason.contains("approval") || reason.contains("APPROVAL") ){
	reason = "Extend extension";
}
else if(reason.contains("SPA") || reason.contains("spa") || reason.contains("sign") || reason.contains("SIGN")){
	reason = "Extend to sign SPA";
}
else{
	reason = "Others";
}
row2.Reason = reason;
row2.DateExtended = row1.DateExtended;
...
pipeline_tmp.ExtensionID = row2.ExtensionHistoryID;
pipeline_tmp.Reason = row2.Reason;
pipeline_tmp.DateExtended = row2.DateExtended ;
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(row3.ExtensionID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, row3.ExtensionID);
}

                            if(row3.Reason == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row3.Reason);
}

                            if(row3.DateExtended != null) {
date_tDBOutput_1 = row3.DateExtended.getTime();
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("pipeline", new Integer(count_tFlowMeter_7), "null", "", "tFlowMeter_7");
...
java.sql.Connection conn_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:e//9FmPvx2zyCL6xvx4X3vZnpK3WDnt3v02YXcd1GreNynwdxax8VTdA");
...
Var.durationUUID = context.getProperty("pipelineUUID") ;// ###############################
        // ###############################
        // # Output tables
...
copyOfpipeline_tmp.ID = 0;
copyOfpipeline_tmp.table_involved = "property_booking_extensions";
copyOfpipeline_tmp.moment = row5.moment;
copyOfpipeline_tmp.pid = row5.pid;
copyOfpipeline_tmp.father_pid = row5.father_pid;
copyOfpipeline_tmp.root_pid = row5.root_pid;
copyOfpipeline_tmp.system_pid = row5.system_pid;
copyOfpipeline_tmp.project = row5.project;
copyOfpipeline_tmp.job = row5.job;
copyOfpipeline_tmp.job_repository_id = row5.job_repository_id;
copyOfpipeline_tmp.job_version = row5.job_version;
copyOfpipeline_tmp.context = row5.context;
copyOfpipeline_tmp.origin = row5.origin;
copyOfpipeline_tmp.label = row5.label;
copyOfpipeline_tmp.count = row5.count;
copyOfpipeline_tmp.reference = row5.reference;
copyOfpipeline_tmp.threshold = row5.thresholds ;
copyOfpipeline_tmp.duration = Var.durationUUID ;
...
if(copyOfpipeline != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                            pstmt_tDBOutput_2.setInt(1, copyOfpipeline.ID);

                            if(copyOfpipeline.table_involved == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, copyOfpipeline.table_involved);
}

                            if(copyOfpipeline.moment != null) {
date_tDBOutput_2 = copyOfpipeline.moment.getTime();
...
pstmt_tDBOutput_2.setNull(3, java.sql.Types.DATE);
                            ...
                            if(copyOfpipeline.pid == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, copyOfpipeline.pid);
}

                            if(copyOfpipeline.father_pid == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, copyOfpipeline.father_pid);
}

                            if(copyOfpipeline.root_pid == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, copyOfpipeline.root_pid);
}

                            if(copyOfpipeline.system_pid == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setLong(7, copyOfpipeline.system_pid);
}

                            if(copyOfpipeline.project == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, copyOfpipeline.project);
}

                            if(copyOfpipeline.job == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, copyOfpipeline.job);
}

                            if(copyOfpipeline.job_repository_id == null) {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(10, copyOfpipeline.job_repository_id);
}

                            if(copyOfpipeline.job_version == null) {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(11, copyOfpipeline.job_version);
}

                            if(copyOfpipeline.context == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, copyOfpipeline.context);
}

                            if(copyOfpipeline.origin == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(13, copyOfpipeline.origin);
}

                            if(copyOfpipeline.label == null) {
pstmt_tDBOutput_2.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(14, copyOfpipeline.label);
}

                            if(copyOfpipeline.count == null) {
pstmt_tDBOutput_2.setNull(15, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(15, copyOfpipeline.count);
}

                            if(copyOfpipeline.reference == null) {
pstmt_tDBOutput_2.setNull(16, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(16, copyOfpipeline.reference);
}

                            if(copyOfpipeline.threshold == null) {
pstmt_tDBOutput_2.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(17, copyOfpipeline.threshold);
}

                            if(copyOfpipeline.duration == null) {
pstmt_tDBOutput_2.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(18, copyOfpipeline.duration);
}
 ...
 */
    ...
    public static void main(String[] args){
        final star_bookingExtension star_bookingExtensionClass = new star_bookingExtension();

        int exitCode = star_bookingExtensionClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = star_bookingExtension.class.getClassLoader().getResourceAsStream("skyworld/star_bookingextension_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = star_bookingExtension.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : star_bookingExtension");
        }
...
/************************************************************************************************
 *     181964 characters generated by Talend Open Studio for Big Data 
 *     on the November 22, 2023 at 8:51:28 AM MYT
 ************************************************************************************************/