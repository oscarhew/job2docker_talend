...
package skyworld.star_soldcancellatinohistory_0_1;
...
/**
 * Job: star_soldCancellatinoHistory Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class star_soldCancellatinoHistory implements TalendJob {
...
public String getPipelineUUID(){
	...
	private final String jobName = "star_soldCancellatinoHistory";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_ikk5oGLIEe6qUseF1Lt1cQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				star_soldCancellatinoHistory.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(star_soldCancellatinoHistory.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_SKYWORLD_star_soldCancellatinoHistory = new byte[0];
    static byte[] commonByteArray_SKYWORLD_star_soldCancellatinoHistory = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SKYWORLD_star_soldCancellatinoHistory.length) {
				if(length < 1024 && commonByteArray_SKYWORLD_star_soldCancellatinoHistory.length == 0) {
   					commonByteArray_SKYWORLD_star_soldCancellatinoHistory = new byte[1024];
				} else {
   					commonByteArray_SKYWORLD_star_soldCancellatinoHistory = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SKYWORLD_star_soldCancellatinoHistory, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_soldCancellatinoHistory, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SKYWORLD_star_soldCancellatinoHistory, 0, length);
			strReturn = new String(commonByteArray_SKYWORLD_star_soldCancellatinoHistory, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SKYWORLD_star_soldCancellatinoHistory) {
...
public static class soldCancellationHistoryPipelineStruct implements routines.system.IPersistableRow<soldCancellationHistoryPipelineStruct> {
    final static byte[] commonByteArrayLock_SKYWORLD_star_soldCancellatinoHistory = new byte[0];
    static byte[] commonByteArray_SKYWORLD_star_soldCancellatinoHistory = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(soldCancellationHistoryPipelineStruct other) {
		...
		synchronized(commonByteArrayLock_SKYWORLD_star_soldCancellatinoHistory) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CategoryID = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CategoryID,dos);
...
soldCancellationHistoryPipelineStruct soldCancellationHistoryPipeline = new soldCancellationHistoryPipelineStruct();
soldCancellationHistoryPipelineStruct row2 = soldCancellationHistoryPipeline;
...
String tableName_tDBOutput_1 = "property_sold_cancellation_history";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:p5e9S5viHjBDfHQlyWt5C0TepQSplEAa61QbTLIXJuA4OKRBUOpODjlh");
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "property_sold_cancellation_history" + "` (`SoldCancellationID`,`SoldDate`,`Reason`,`CancellationCategory`) VALUES (?,?,?,?)";
 ...
 */
	...
	currentComponent="tFlowMeter_7";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"soldCancellationHistoryPipeline");
					}
...
soldCancellationHistoryPipelineStruct soldCancellationHistoryPipeline_tmp = new soldCancellationHistoryPipelineStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SvYDmfqsqJ7dcKyJpIT71QbyERQhVMK14x7bVZXRDMoKmKQ0M+93swNM");
...
+"By`\nFROM `property_soldcancellatinohistory`";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.SoldCancellationHistoryID = 0;
							} else {
		                          
            row1.SoldCancellationHistoryID = rs_tDBInput_1.getInt(1);
            ...
            row1.BookingUnitID = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.ProjectID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
        	...
        	row1.CustomerID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
				...
				if(rs_tDBInput_1.getString(6) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.SoldDate = rs_tDBInput_1.getTimestamp(6);
					} else {
						row1.SoldDate = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.SoldDate =  null;
				}
				...
				if(rs_tDBInput_1.getString(7) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateCancellation = rs_tDBInput_1.getTimestamp(7);
					} else {
						row1.DateCancellation = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.DateCancellation =  null;
				}
        	...
        	row1.AddedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.Reason = null;
							} else {
	                         		
        	row1.Reason = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
        	...
        	row1.CategoryID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.Deleted = null;
							} else {
	                         		
            row1.Deleted = rs_tDBInput_1.getBoolean(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.Deleted = null;
            }
		                    }
				...
				if(rs_tDBInput_1.getString(13) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateCreated = rs_tDBInput_1.getTimestamp(13);
					} else {
				...
				if(rs_tDBInput_1.getString(14) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DateModified = rs_tDBInput_1.getTimestamp(14);
					} else {
        	...
        	row1.CreatedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.ModifiedBy = null;
							} else {
	                         		
        	row1.ModifiedBy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
...
soldCancellationHistoryPipeline = null;


// # Output table : 'soldCancellationHistoryPipeline'
soldCancellationHistoryPipeline_tmp.SoldCancellationID = row1.SoldCancellationHistoryID ;
soldCancellationHistoryPipeline_tmp.SoldDate = row1.SoldDate;
soldCancellationHistoryPipeline_tmp.Reason = row1.Reason;
soldCancellationHistoryPipeline_tmp.CancellationCategory = row1.CategoryID ;
soldCancellationHistoryPipeline = soldCancellationHistoryPipeline_tmp;
// ###############################
 ...
 */
// Start of branch "soldCancellationHistoryPipeline"
if(soldCancellationHistoryPipeline != null) { 
	...
	currentComponent="tFlowMeter_7";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"soldCancellationHistoryPipeline"
    ...
    count_tFlowMeter_7++; 
     ...
     row2 = soldCancellationHistoryPipeline;
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            pstmt_tDBOutput_1.setInt(1, row2.SoldCancellationID);

                            if(row2.SoldDate != null) {
date_tDBOutput_1 = row2.SoldDate.getTime();
...
} else {pstmt_tDBOutput_1.setString(3, row2.Reason);
}

                            if(row2.CancellationCategory == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row2.CancellationCategory);
}
...
} // End of branch "soldCancellationHistoryPipeline"
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("soldCancellationHistoryPipeline", new Integer(count_tFlowMeter_7), "null", "", "tFlowMeter_7");

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"soldCancellationHistoryPipeline");
			  	}
...
java.sql.Connection conn_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5H4POWuXGVFYHofqAy5F+v90c1Ms2WhpmOPV/sylmG4yJhVAe1tS9dbM");
...
pipeline_tmp.ID = 0;
pipeline_tmp.table_involved = "property_sold_cancellation_history";
 ...
 */
    ...
    public static void main(String[] args){
        final star_soldCancellatinoHistory star_soldCancellatinoHistoryClass = new star_soldCancellatinoHistory();

        int exitCode = star_soldCancellatinoHistoryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = star_soldCancellatinoHistory.class.getClassLoader().getResourceAsStream("skyworld/star_soldcancellatinohistory_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = star_soldCancellatinoHistory.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : star_soldCancellatinoHistory");
        }
...
/************************************************************************************************
 *     167432 characters generated by Talend Open Studio for Big Data 
